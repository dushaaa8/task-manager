...
import Selector, { type ISelectOption } from "./Selector";
import type { TasksPriority } from "./TaskItem";
...
const priorityOptions: ISelectOption<TasksPriority>[] = [
  { value: "low", label: "Low" },
...
export function TaskFormModal({
  ...
  const [priority, setPriority] = useState<TasksPriority>("low");
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            <div className="relative">
              ...
              {isCalendarOpen && (
                <div className="absolute top-full -right-5 z-50 mt-2 w-max rounded-3xl bg-white p-4 shadow-[0_8px_30px_rgb(0,0,0,0.12)] border border-gray-100">
                  <Calendar
